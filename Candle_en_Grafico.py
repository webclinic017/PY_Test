...
ap = [ mpf.make_addplot(df[['RSI','SMA_RSI']],type='line', ax=ax2, ylabel='RSI'),
       mpf.make_addplot(df[['SMA_Rapida','SMA_Lenta']], type='line', ax=ax1, ylabel='SMAs')
     ]
...
# Plot grafico
mpf.plot(df, type='candle', ax=ax1, addplot=ap)
mpf.show()
